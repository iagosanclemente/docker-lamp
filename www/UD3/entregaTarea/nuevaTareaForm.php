    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    <form class="mb-5" action="nuevaTarea.php" method="post">
                        <div class="mb-3">
                            <p>Titulo : <input class="form-control" type="text" name="titulo_tarea" required/></p>
                        </div>
                        <div class="mb-3">
                                ...
                                <?php
                                    ...
                                    if ($resultados && count($resultados) > 0) {
                                        foreach ($resultados as $resultado) {
                                            echo '<option value="' . $resultado['id'] . '">' . $resultado['nombre'] . ' ' . $resultado['apellidos'] . '</option>';
                                        }
                                    } else {
